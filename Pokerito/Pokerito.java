...
public class Pokerito {
    public static void main(String[] args) {
        ...
        System.out.println("The dealer will draw a card every time you press enter.");
        scan.nextLine();
        for(int i=1;i<6;i++){
            scan.nextLine();
        ...
        System.out.println("Your Matches are: "+yourMatches);
        System.out.println("The computer Matches are: "+computerMatches);
